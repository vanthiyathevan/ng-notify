...
// User customizations...
     ...
     */
    this.addTheme= function (themeName, themeClass) {
     ...
     */
    this.addType= function (typeName, typeClass) {
      if (!typeName || !typeClass) {
        return;
      }
      types[typeName + 'Class'] = typeClass;
    };
    function $get($document, $compile, $rootScope, $timeout, $interval) {
      ...
      /**
       * Our main notify function
       *
       * @type {Function}
       */
      return function (message, userOpt) {
...
//      return notifyObject;
    ...
    $get.$inject = ['$document', '$compile', '$rootScope', '$timeout', '$interval'];
    this.$get = $get;
